/*
 * Das Script parst Termine von Veranstaltungen aus dem Veranstaltungskalender der Stadtrevue Köln
...
function createPageDescription(text){
...
function rebuildPrice(text,preis){
  var r;
...
function filterOrt(text,ortsname){
  var ex = /[^\w]Ort:.*/;
